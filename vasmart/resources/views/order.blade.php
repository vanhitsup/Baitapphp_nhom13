                                    ...
                                    <div class="table-content table-responsive mb-50">
                                        <table class="text-center">
                                            ...
                                            <tr>
                                                <td class="product-thumbnail">
                                                    <div class="pro-thumbnail-img">
                                                        <img src="{{asset('../public/frontend/img/cart/1.jpg')}}" alt="">
                                                    </div>
                                            ...
                                            <tr>
                                                <td class="product-thumbnail">
                                                    <div class="pro-thumbnail-img">
                                                        <img src="{{asset('../public/frontend/img/cart/2.jpg')}}" alt="">
                                                    </div>
                                                    <div class="pro-thumbnail-info text-left">
                                                        <h6 class="product-title-2">
                                                            <a href="#">dummy product name</a>
                                            ...
                                            <tr>
                                                <td class="product-thumbnail">
                                                    <div class="pro-thumbnail-img">
                                                        <img src="{{asset('../public/frontend/img/cart/3.jpg')}}" alt="">
                                                    </div>
                                                    <div class="pro-thumbnail-info text-left">
                                                        <h6 class="product-title-2">
                                                            <a href="#">dummy product name</a>
                        ...
                        <div class="tab-pane active" id="order-complete">
                            <div class="order-complete-content box-shadow">
                                <div class="thank-you p-30 text-center">
                                    <h6 class="text-black-5 mb-0">Cảm ơn bạn đã đặt hàng.Đơn hàng của bạn đang được xử lý .</h6>
                                </div>
