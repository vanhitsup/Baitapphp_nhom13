...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <!-- Sidebar - Brand -->
        <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{\Illuminate\Support\Facades\URL::to('dashboard')}}">
            <div class="sidebar-brand-icon rotate-n-15">
                <i class="fas fa-laugh-wink"></i>
            </div>
            <div class="sidebar-brand-text mx-3">Admin <sup>va</sup></div>
        </a>
        ...
        <li class="nav-item active">
            <a class="nav-link"  href="{{\Illuminate\Support\Facades\URL::to('dashboard')}}">
        ...
        <li class="nav-item">
            ...
            <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    <a class="collapse-item" href="{{\Illuminate\Support\Facades\URL::to('add-category-product')}}">Thêm danh mục sản phẩm</a>
                    <a class="collapse-item" href="{{\Illuminate\Support\Facades\URL::to('list-category-product')}}">List danh mục sản phẩm</a>
                </div>
            </div>
        </li>
        <hr class="sidebar-divider">
        ...
        <li class="nav-item">
            ...
            <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                ...
                <div class="bg-white py-2 collapse-inner rounded">
                    <a class="collapse-item" href="{{\Illuminate\Support\Facades\URL::to('add-brand-product')}}">Thêm thương hiệu</a>
                    <a class="collapse-item" href="{{\Illuminate\Support\Facades\URL::to('list-brand-product')}}">List thương hiệu</a>
                </div>
            </div>
        </li>
        ...
        <li class="nav-item">
            ...
            <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item" href="{{\Illuminate\Support\Facades\URL::to('add-product')}}">Thêm sản phẩm</a>
                    <a class="collapse-item" href="{{\Illuminate\Support\Facades\URL::to('list-product')}}">List sản phẩm</a>
        ...
        <!-- Nav Item - Tables -->
        <li class="nav-item">
            <a class="nav-link" href="list_category_product.blade.php">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item dropdown no-arrow">
                        <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                           data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            ...
                            <img class="img-profile rounded-circle"
                                 src="{{asset('backend/img/ptvanh.jpg')}}">
                        </a>
                        ...
                        <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                            ...
                            <a class="dropdown-item" href="{{\Illuminate\Support\Facades\URL::to('logout')}}" data-toggle="modal" data-target="#logoutModal">
            ...
            {{--                    <h1 class="h3 mb-0 text-gray-800"  style="margin-left: 50px">Danh Sách Danh Mục Sản Phẩm</h1>--}}
            {{--                </div>--}}
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a class="btn btn-primary" href="{{\Illuminate\Support\Facades\URL::to('logout')}}">Logout</a>
            </div>
        </div>
    </div>
</div>
