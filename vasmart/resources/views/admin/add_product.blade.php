...
//                ?>
                <form role="form" action="{{\Illuminate\Support\Facades\URL::to('save-product')}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="product_name" class="form-control" id="exampleInputEmail1" placeholder="Nhập tên danh mục sản phẩm">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea type="text" name="product_desc" class="form-control" id="exampleInputEmail1 product_desc "></textarea>
                    </div>

                    <div class="form-group">
                        <label for="exampleInputEmail1">Nội dung sản phẩm</label>
                        <textarea type="text" name="product_content" class="form-control" id="exampleInputEmail1" ></textarea>
                    </div>
